<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="领队教师" prop="lingduijiaoshi">
          <el-input v-model="ruleForm.lingduijiaoshi" 
              placeholder="领队教师" clearable  :readonly="ro.lingduijiaoshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="领队教师" prop="lingduijiaoshi">
              <el-input v-model="ruleForm.lingduijiaoshi" 
                placeholder="领队教师" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cansaichengyuan = true;
          ...
          if(o=='lingduijiaoshi'){
            this.ruleForm.lingduijiaoshi = obj[o];
	    this.ro.lingduijiaoshi = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `wangnianchengji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wangnianchengjiCrossAddOrUpdateFlag = false;
                  this.parent.search();

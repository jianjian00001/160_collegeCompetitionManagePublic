  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:#000;fontSize:28px;">高校学科竞赛平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='lingduijiaoshi'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='lingduijiaoshi'">
			  <el-input v-model="ruleForm.zhanghao" autocomplete="off" placeholder="账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='lingduijiaoshi'" class="input-group">
			   <div class="label">密码</div>
			...
			<el-form-item label="密码" class="input" v-if="tableName=='lingduijiaoshi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='lingduijiaoshi'" class="input-group">
			   <div class="label">姓名</div>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='lingduijiaoshi'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='lingduijiaoshi'" class="input-group">
			   <div class="label">教工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaogonghao" class="input" type="text" placeholder="教工号">
			   </div>
			 </div> -->
			<el-form-item label="教工号" class="input" v-if="tableName=='lingduijiaoshi'">
			  <el-input v-model="ruleForm.jiaogonghao" autocomplete="off" placeholder="教工号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='lingduijiaoshi'" class="input-group">
			   <div class="label">手机</div>
			   <div class="input-container">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='lingduijiaoshi'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='lingduijiaoshi'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='lingduijiaoshi'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.zhanghao) && `lingduijiaoshi` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `lingduijiaoshi` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if(`lingduijiaoshi` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      if(`lingduijiaoshi` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      this.$http({
